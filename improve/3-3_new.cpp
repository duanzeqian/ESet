...
int main()
{
    ...
    for (int j = 1; j <= M; ++j)
    {
        ...
        auto iter1 = s1.begin();
        while (iter1 != s1.end()) ++iter1;
        while (iter1 != s1.begin()) --iter1;
        auto end1 = chrono::high_resolution_clock::now();
        auto start2 = chrono::high_resolution_clock::now();
        auto iter2 = s2.begin();
        while (iter2 != s2.end()) ++iter2;
        while (iter2 != s2.begin()) --iter2;
        auto end2 = chrono::high_resolution_clock::now();
        auto start3 = chrono::high_resolution_clock::now();
        auto iter3 = s3.begin();
        while (iter3 != s3.end()) ++iter3;
        while (iter3 != s3.begin()) --iter3;
